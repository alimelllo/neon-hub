    ...
    return (
        <div className='w-full h-[5rem] md:py-2 z-30 bg-[#56e1f0] flex flex-row items-center'>
            <div className='w-full h-[80%] flex z-40 flex-row justify-between'>
                ...
                <div className='w-4/12 text-[gray] bg-[pink] font-[Vazir] text-[1.25rem] flex flex-row md:hidden items-center justify-center '>
                ...
                <div className='w-4/12 bg-[green] text-[white] font-[Vazir] text-[1.25rem] md:text-[1rem] justify-end flex flex-row items-center pr-5 '>
